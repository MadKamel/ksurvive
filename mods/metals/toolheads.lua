minetest.register_craftitem("metals:pick_head_copper", {
	description = "Wrought Copper Pickaxe Head",
	inventory_image = "toolhead_copper_pick.png"
})

minetest.register_craftitem("metals:pick_head_iron", {
	description = "Wrought Iron Pickaxe Head",
...
minetest.register_craftitem("metals:shovel_head_copper", {
	description = "Wrought Copper Shovel Head",
	inventory_image = "toolhead_copper_shovel.png"
})
...
minetest.register_craftitem("metals:axe_head_copper", {
	description = "Wrought Copper Axe Head",
	inventory_image = "toolhead_copper_axe.png"
})

minetest.register_craftitem("metals:axe_head_iron", {
	description = "Wrought Iron Axe Head",
...
minetest.register_craftitem("metals:hammer_head_copper", {
	description = "Wrought Copper Hammer Head",
	inventory_image = "toolhead_copper_hammer.png"
})
...
minetest.register_craftitem("metals:sword_head_copper", {
	description = "Wrought Copper Sword Blade",
	inventory_image = "toolhead_copper_sword.png"
})

minetest.register_craftitem("metals:sword_head_iron", {
	description = "Wrought Iron Sword Blade",
...
minetest.register_craftitem("metals:copper_stick", {
	description = "Wrought Copper Stick",
	inventory_image = "copper_stick.png"
})
